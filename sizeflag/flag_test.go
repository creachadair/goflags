...
func TestSet(t *testing.T) {
	tests := []struct {
		...
		// All the named units work, and case does not matter.
		{"1k", 1 << 10, 1e3}, {"1K", 1 << 10, 1e3},
		{"1m", 1 << 20, 1e6}, {"1M", 1 << 20, 1e6},
		{"1g", 1 << 30, 1e9}, {"1G", 1 << 30, 1e9},
		{"1t", 1 << 40, 1e12}, {"1T", 1 << 40, 1e12},
		{"1p", 1 << 50, 1e15}, {"1P", 1 << 50, 1e15},
		{"1e", 1 << 60, 1e18}, {"1E", 1 << 60, 1e18},
